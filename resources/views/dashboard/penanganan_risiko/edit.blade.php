        ...
        <div class="row g-4 justify-content-center">
            <div class="col-10">
                <div class="bg-light rounded h-100 p-4">
                    <h3 class="mb-4 text-center">Input Penanganan Risk</h3>
                    <form action="{{ route('penanganan_risiko.update', $Risk->id) }}}" method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <h5 class="mb-4">Evaluasi dan Rencana Penanganan Risiko</h5>
                        <div class="form-floating mb-3">
                        ...
                        <h5 class="mb-4">Risiko Residual</h5>
                        <div class="d-lg-flex justify-content-beetween">
                            <div class="form-floating mb-3 col-lg-6 col-12 pe-lg-2 pe-0">
                        ...
                        <div class="my-4 text-end">
                            <button type="submit" class="btn btn-outline-primary ml-auto">Tambah Penanganan</button>
                        </div>
                    </form>
                </div>
            </div>
